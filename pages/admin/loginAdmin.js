    ...
    <div className="wrapper">
        ...
        <div className="card">
            <form action="#" className="d-flex flex-column">
                <div className="h3 text-center text-white">Login Admin</div>
                ...
                <div className="my-3"> <a href="/admin/berandaAdmin" type="submit" value="Login" className="btn btn-primary">Login</a></div>
